...
public class  Destination extends Customer
{
	...
	public void setCostOfPlace(int costOfPlace)
	{
		this.costOfPlace= costOfPlace;
	}
	public int getCostOfPlace()
	{
		return costOfPlace;
	}
	...
	{  
	int totalFare=  (costOfTransport*numberOfPerson)+costOfPlace+(roomFare*numberOfDays)+tpcost;
